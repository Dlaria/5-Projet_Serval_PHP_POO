...
<body style="
background: no-repeat center/cover url(../images/<?= $_SESSION['select_doc'] ?>/background.jpg);
">
    <section id="section-2">
        <img src="../images/<?= $_SESSION['select_doc'] ?>/interface.png" class="hud">
        <div class="screen">
            <img class="screen" src="
            ../images/<?= $_SESSION['select_doc'] ?>/<?= $view->getView(); ?>.jpg" 
            alt="">
        </div>
