...
if (count($_POST) != 0){
    ...
    foreach ($_POST as $key => $value){
        switch ($key){
            ...
            case 'rightRotate':
                ...
                break;
            case 'btnAction':
                if ($view->getCurrentX() == 1 && $view->getCurrentY() == 0 && $view->getCurrentAngle() == 270){
                    $view->setActionStatus(2);
                }
    ...
    if (isset($_SESSION['chapeau']) && $view->getCurrentX() == 0 && $view->getCurrentY() == 1 && $view->getCurrentAngle() == 0){
        unset($_SESSION['chapeau']);
    }
?>
<!DOCTYPE html>
<html lang="fr">
...
<body style="
background:#00000090 no-repeat center/cover url(../images/<?= $_SESSION['select_doc'] ?>/background.jpg);
...
">
    ...
    <div class="screen">
        <img class="screen" src="../images/<?= $_SESSION['select_doc'] ?>/<?= $view->getView(); ?>.jpg" alt="">
    </div>
